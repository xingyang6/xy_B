...
//public static <T> void doSpinner(Context context, Spinner spinner, Spinner[] a){
//        ArrayAdapter<String> mspinner=new ArrayAdapter<T>(context);
////    ArrayAdapter<String> mspinner=new ArrayAdapter<>(context, R.layout.item,a);
